...
import {
    ENUM_MOMENT_HELPER_DATE_DIFF,
    ENUM_MOMENT_HELPER_DATE_FORMAT,
} from 'src/common/helper/enums/helper.moment.enum';
import {
...
} from 'src/common/helper/interfaces/helper.moment.interface';
import { IHelperMomentDateService } from 'src/common/helper/interfaces/helper.moment.date-service.interface';

@Injectable()
export class HelperMomentDateService implements IHelperMomentDateService {
    ...
    diff(
        ...
        if (options?.format === ENUM_MOMENT_HELPER_DATE_DIFF.MILIS) {
            return diff.asMilliseconds();
        } else if (options?.format === ENUM_MOMENT_HELPER_DATE_DIFF.SECONDS) {
            return diff.asSeconds();
        } else if (options?.format === ENUM_MOMENT_HELPER_DATE_DIFF.HOURS) {
            return diff.asHours();
        } else if (options?.format === ENUM_MOMENT_HELPER_DATE_DIFF.MINUTES) {
    ...
    format(
        ...
        return moment(date)
            .tz(tz)
            .format(options?.format ?? ENUM_MOMENT_HELPER_DATE_FORMAT.DATE);
    }
